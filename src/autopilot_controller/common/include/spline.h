/*
 * spline.h
 * from https://github.com/ttk592/spline/blob/master/src/spline.h
...
// spline interpolation
    ...
    public:
        ...
        spline() :
                m_left(second_deriv), m_right(second_deriv), m_left_value(0.0), m_right_value(
                0.0), m_force_linear_extrapolation(false) {
            ;
        }
