...
AirSimcontroller::AirSimcontroller(const std::string &inifilename, const std::string &controller_name,
...
#define KP_RATIO 2.2
    ...
    Kp_acc = 40.0;    // 75 16 20
    Ki_acc = 0.2; //10
    Kd_acc = 85.0;
    Kaccd_acc = -0.0;
    offset_acc = 0.0;

    ival_acc_upper_limit = 12.00;
    ival_acc_lower_limit = -12.0;
