...
#ifndef __nad_lcm_cu_alarm_report_hpp__
#define __nad_lcm_cu_alarm_report_hpp__
...
int cu_alarm_report::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cu_alarm_report::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int cu_alarm_report::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t cu_alarm_report::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* cu_alarm_report::getTypeName()
{
    return "cu_alarm_report";
}

int cu_alarm_report::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cu_alarm_report::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int cu_alarm_report::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
int64_t cu_alarm_report::_computeHash(const __lcm_hash_ptr *)
{
    int64_t hash = 0xbde4404e5da10d7eLL;
