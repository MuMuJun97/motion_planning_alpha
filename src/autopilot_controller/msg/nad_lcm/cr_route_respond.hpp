...
#ifndef __nad_lcm_cr_route_respond_hpp__
#define __nad_lcm_cr_route_respond_hpp__
...
int cr_route_respond::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cr_route_respond::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int cr_route_respond::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t cr_route_respond::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* cr_route_respond::getTypeName()
{
    return "cr_route_respond";
}

int cr_route_respond::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cr_route_respond::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int cr_route_respond::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
int64_t cr_route_respond::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == cr_route_respond::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)cr_route_respond::getHash };
