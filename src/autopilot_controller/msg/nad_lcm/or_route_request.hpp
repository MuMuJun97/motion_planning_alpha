...
#ifndef __nad_lcm_or_route_request_hpp__
#define __nad_lcm_or_route_request_hpp__
...
int or_route_request::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int or_route_request::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int or_route_request::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t or_route_request::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* or_route_request::getTypeName()
{
    return "or_route_request";
}

int or_route_request::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int or_route_request::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int or_route_request::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
int64_t or_route_request::_computeHash(const __lcm_hash_ptr *)
{
    int64_t hash = 0x0b700f62681ec66aLL;
