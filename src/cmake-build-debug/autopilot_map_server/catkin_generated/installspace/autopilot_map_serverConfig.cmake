...
if(autopilot_map_server_CONFIG_INCLUDED)
  return()
endif()
set(autopilot_map_server_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(autopilot_map_server_SOURCE_PREFIX /home/trouble/ros_ws/motion_planning_alpha/src/autopilot_map_server)
  set(autopilot_map_server_DEVEL_PREFIX /home/trouble/ros_ws/motion_planning_alpha/src/cmake-build-debug/devel)
  set(autopilot_map_server_INSTALL_PREFIX "")
  set(autopilot_map_server_PREFIX ${autopilot_map_server_DEVEL_PREFIX})
else()
  set(autopilot_map_server_SOURCE_PREFIX "")
  set(autopilot_map_server_DEVEL_PREFIX "")
  set(autopilot_map_server_INSTALL_PREFIX /usr/local)
  set(autopilot_map_server_PREFIX ${autopilot_map_server_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'autopilot_map_server' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/trouble/ros_ws/motion_planning_alpha/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(autopilot_map_server_LIBRARY_DIRS ${lib_path})
      list(APPEND autopilot_map_server_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'autopilot_map_server'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND autopilot_map_server_LIBRARIES ${lib})
    endif()
  endif()
...
set(autopilot_map_server_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${autopilot_map_server_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "autopilot_msgs;boost;roscpp;rospy;std_msgs;tf")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 autopilot_map_server_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${autopilot_map_server_dep}_FOUND)
      find_package(${autopilot_map_server_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${autopilot_map_server_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(autopilot_map_server_INCLUDE_DIRS ${${autopilot_map_server_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(autopilot_map_server_LIBRARIES ${autopilot_map_server_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${autopilot_map_server_dep}_LIBRARIES})
  _list_append_deduplicate(autopilot_map_server_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(autopilot_map_server_LIBRARIES ${autopilot_map_server_LIBRARIES})

  _list_append_unique(autopilot_map_server_LIBRARY_DIRS ${${autopilot_map_server_dep}_LIBRARY_DIRS})
  list(APPEND autopilot_map_server_EXPORTED_TARGETS ${${autopilot_map_server_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${autopilot_map_server_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
